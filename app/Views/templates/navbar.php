<nav class="navbar">
    ...
    <div class="inner-width">
               ...
               <button class="button"><a href="#" style="text-decoration: none; color:black;">Home</a></button>
               <button class="button"><a href="#" style="text-decoration: none; color:black;">Play game</a></button>

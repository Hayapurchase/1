...
class AdminController extends BaseController
{
    ...
    {
        return view('Admin/Frontend/Home/adminhome');
    }
    ...
    {  
        ...
        if($role==3){
            ...
            return redirect()->to('users')->with('status','A New User Has Been Deleted');
        }
        elseif($role==1){ 
    ...
    public function update_user($usertype)
    {
        ...
        return redirect()->to('users')->with('status','A New User Has Been Updated');
    ...
    {
        return view('Admin/Frontend/Uploads/index');
    }
